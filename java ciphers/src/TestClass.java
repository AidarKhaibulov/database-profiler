...
public class TestClass {
    ...
    @Test
    @DisplayName("Simple cipher bits")
    public void simpleTest6() {
        CipherManager cm = new CipherManager(5);
        assertEquals("10001011101011111000100010100011", cm.applyCipherToString("00110011001111110011000000101011"));
    }
